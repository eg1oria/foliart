...
export const adminPrimaryButtonClassName =
  'inline-flex cursor-pointer min-h-11 min-w-0 items-center justify-center rounded-lg bg-[#0b5a45] px-4 py-2.5 text-center text-sm font-semibold text-white transition hover:bg-[#094635] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0b5a45]/20';
export const adminSecondaryButtonClassName =
  'inline-flex cursor-pointer min-h-10 min-w-0 items-center justify-center rounded-lg border border-[#0b5a45]/14 bg-white px-3.5 py-2 text-center text-sm font-semibold text-[#0b3e31] transition hover:border-[#0b5a45]/30 hover:bg-[#eef4ef] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0b5a45]/12';
export const adminDangerButtonClassName =
  'inline-flex cursor-pointer min-h-10 min-w-0 items-center justify-center rounded-lg border border-red-200 bg-white px-3.5 py-2 text-center text-sm font-semibold text-red-700 transition hover:border-red-300 hover:bg-red-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500/20 disabled:cursor-not-allowed disabled:opacity-60';
